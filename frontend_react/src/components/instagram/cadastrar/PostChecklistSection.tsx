...
import { ChecklistItem as ChecklistItemComponent } from '../../aulas/cadastrar/ChecklistItem';
    ...
    <section className="bg-white rounded-2xl border border-slate-200 border-l-[6px] border-l-girlies-purple shadow-sm p-6 relative">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="bg-slate-100 text-slate-500 px-2.5 py-1 rounded-md text-[10px] font-bold font-mono tracking-widest uppercase border border-slate-200">Post</span>
        </div>
      </div>
